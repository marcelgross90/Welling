...
public class ResourceInputView extends CustomView {
	...
	public ResourceInputView(String packageName, String className) {
		super(packageName, className, getScrollViewClassName());
